class Node
  ...
  def self.build_tree(sorted_array)
    # sorted_array.sort!
    p sorted_array

    @@root = self.new( sorted_array.delete_at( (sorted_array.size/2.0 - 1).round ) )
...
tree = Node.build_tree([1, 7, 4, 23, 8, 9, 4, 3, 5, 7, 9, 67, 6345, 358])
